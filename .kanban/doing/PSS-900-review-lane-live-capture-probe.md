...
## Summary
Add a tiny pure `greet(name)` helper that returns `"hello, <name>"`, with a unit test
asserting that exact output. This probe exercises the AI6P-1046 Route C review lane
end-to-end on the sacrificial repo.
